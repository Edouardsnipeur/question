                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    Abonne<span class="badge bg-blue">{{$suscribers->count()}}</span>
                                </h2>
                                        ...
                                        @foreach($suscribers as $k => $v)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <form action="{{route('admin.suscriber.destroy',$v)}}" id="form-data-{{$v->id}}" method="post">
                                                        {{csrf_field()}}
