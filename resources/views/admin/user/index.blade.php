    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <a class="btn btn-primary waves-effect" href="{{route('admin.user.create')}}" style="margin-bottom: 15px">
                                        ...
                                        @foreach($users as $k => $v)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-primary" href="{{route('admin.user.edit',$v)}}">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    @if(\Illuminate\Support\Facades\Auth::user()->id!=$v->id)
