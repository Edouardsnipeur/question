                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    Devis<span class="badge bg-blue">{{$devis->count()}}</span>
                                </h2>
                                        ...
                                        @foreach($devis as $k => $v)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-primary" href="{{route('admin.devi.edit',$v)}}">
                                                        <i class="material-icons" >edit</i>
                                                    </a>
                                                    <a class="btn btn-primary" href="{{route('admin.devi.show',$v)}}">
                                                    ...
                                                    <form action="{{route('admin.devi.destroy',$v)}}" id="form-data-{{$v->id}}" method="post">
                                                        {{csrf_field()}}
